...
export type INotificationWidgetPosition = "top" | "bottom";

export interface INotificationWidgetStyle extends IWidgetStyle
{
  height: number;
  position: INotificationWidgetPosition;
  width: number;
}

export type ISidebarWidgetPosition = "left" | "right";

export interface ISidebarWidgetStyle extends IWidgetStyle
{
  height: number;
  position: ISidebarWidgetPosition;
  width: number;
}
