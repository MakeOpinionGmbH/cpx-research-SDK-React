    ...
    <Fragment>
      ...
      <div className="App">
        <div className="App-header">
          ...
          <p className={"demo-text"}>CPX React Demo</p>
          <CpxSurveyCards
          ...
          <div className={"action-buttons"}>
            <button onClick={() => fetchSurveysAndTransactionsRef.current?.()}>
              Fetch surveys and transactions
            </button>
            <button onClick={() => markTransactionAsPaidRef.current?.("123", "345")}>
              Mark Transaction as paid
            </button>
            <button onClick={() => setIsCpxLayerHidden(false)}>
              Show CPX Layer
            </button>
            <button onClick={() => setIsCpxLayerHidden(true)}>
              Hide CPX Layer
            </button>
            <button onClick={() => openWebViewRef.current?.(/* pass optional surveyId here */)}>
              Open Webview
            </button>
          </div>
        </div>
